...
function Utils.MakeCapsule( name )
  data:extend({
  {
    type = "capsule",
    name = name,
...
function Utils.MakeRecipe( name )
  data:extend({
  {
    type = "recipe",
    name = name,
...
function Utils.MakeSticker( name )
  data:extend({
    {
      type = "sticker",
      name = name,
...
function Utils.MakeX( name )

end

-------------------------------------------------------------------------------

function Utils.addEffectToTech( newTech, recipe )
...
function Utils.addBoostersTechnology( attributes )
  -- local name = "sbc-technology-boosters" .. attributes.name
